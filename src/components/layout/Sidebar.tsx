  ...
  const navItems = [
    {
      ...
      path: '/dashboard',
      icon: 'grid_view',
      description: 'Municipal Siting Matrix',
    },
    {
      label: 'Site Intelligence',
      path: '/sites',
      icon: 'map',
      description: '2D GIS Map & Screening',
    },
    {
      label: 'Ranked Sites',
      path: '/sites/ranked',
    ...
    },
    {
      ...
      description: 'Plot Boundary & Measurement',
    },
    {
      label: '3D Conceptual Planner',
      path: '/planning/nashik-site-01/3d',
      icon: 'view_in_ar',
      description: 'CesiumJS 3D Placement',
    },
    {
    ...
    },
    {
      ...
      path: '/proposals/prop-nashik-01',
      icon: 'description',
      description: 'Decision Package Workspace',
    },
    {
      label: 'Saved Proposals',
      path: '/proposals',
      icon: 'folder_special',
      description: 'Proposal Library',
    },
    {
      label: 'Data & Analysis Layers',
      path: '/data-layers',
      icon: 'layers',
      description: 'GIS Overlays & Proxies',
    },
  ];
