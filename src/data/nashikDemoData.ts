...
export const NASHIK_DEMO_SITES: CandidateSite[] = [
  {
    id: 'nashik-site-01',
    code: 'NASHIK-SITE-01',
    name: 'Govardhan Bus Depot Substation Parcel',
    city: 'Nashik',
    ward: 'Ward 14 - Trimbak Road Axis',
    zone: 'Western Transit Corridor',
    opportunityScore: 84,
    status: 'RECOMMENDED',
    lat: 19.9975,
    lng: 73.7898,
  ...
  },
  {
    ...
    city: 'Nashik',
    ward: 'Ward 8 - MIDC Satpur',
    zone: 'Satpur Industrial Estate',
    opportunityScore: 78,
    status: 'RECOMMENDED',
    lat: 19.9882,
    lng: 73.7421,
  ...
  },
  {
    ...
    city: 'Nashik',
    ward: 'Ward 22 - Ambad Link Road',
    zone: 'Southern Bypass Belt',
    opportunityScore: 72,
    status: 'UNDER_REVIEW',
    lat: 19.9450,
    lng: 73.7610,
  ...
  },
  {
    ...
    city: 'Nashik',
    ward: 'Ward 3 - Panchavati',
    zone: 'Central Cultural Core',
    opportunityScore: 59,
    status: 'SCREENING',
    lat: 20.0089,
    lng: 73.7954,
...
export const NASHIK_DEMO_PROPOSALS: Proposal[] = [
  {
    id: 'prop-nashik-01',
